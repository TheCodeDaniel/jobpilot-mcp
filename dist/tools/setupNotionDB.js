...
export async function setupNotionDB(args) {
    ...
    if (NOTION_DATABASE_ID) {
        const checkRes = await fetch(`https://api.notion.com/v1/databases/${NOTION_DATABASE_ID}`, {
            headers: {
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            success: true,
                            message: "Database already set up — no action needed.",
        ...
        content: [
            {
                ...
                text: JSON.stringify({
                    success: true,
                    message: "Notion database created successfully. Set the database_id below as NOTION_DATABASE_ID in your .env or Claude Desktop config.",
                    database_id: db.id,
                    database_url: db.url,
                }, null, 2),
            },
...
//# sourceMappingURL=setupNotionDB.js.map