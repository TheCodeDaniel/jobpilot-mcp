...
function extractExperience(sections) {
    ...
    for (const block of blocks) {
        ...
        const dateMatch = block.match(/((?:jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)\w*[\s,]*\d{4}|20\d{2}|19\d{2})\s*[-–—to]+\s*((?:jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)\w*[\s,]*\d{4}|20\d{2}|19\d{2}|present|current|now)/i);
